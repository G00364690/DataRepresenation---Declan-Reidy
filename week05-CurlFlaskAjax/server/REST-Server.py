...
#create a list called cars to store them inside memory. 
#as soon as the server is stopped its all gone. 
cars = [
    {
        "reg":"181 G 1234",
        "make":"Ford",
...
#App.route with a get method to find the reg
...
#to create. Check the input criteria is satisfied
#if yes, append to the list cars
...
#take the reg in, search the list, make an array of found cars (first found car)
